...
@class XDTAs99Parser, XDTAs99Objcode;


NS_ASSUME_NONNULL_BEGIN

@interface XDTAs99Directives : XDTObject

@property (readonly, copy, nullable) NSArray<NSString *> *ignored;

+ (nullable instancetype)directives;
